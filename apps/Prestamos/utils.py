...
def set_pagination(request, items, item_numer=5):
    ...
    items.pagination = render_to_string('prestamos/partial/pagination.html', context)
    return items, {'current_page': page, 'items': item_len, 'items_on_page': item_numer}



def set_pagination_borrower(request, items, item_numer=10):
    if not items:
        return True, "These is no items"
    ...
    items.pagination = render_to_string('prestamos/partial/pagination.html', context)
    return items, {'current_page': page, 'items': item_len, 'items_on_page': item_numer}
def set_pagination_prestamos(request, items, item_numer=10):
    if not items:
        return True, "These is no items"
    ...
    items.pagination = render_to_string('prestamos/partial/pagination.html', context)
    return items, {'current_page': page, 'items': item_len, 'items_on_page': item_numer}
def set_pagination_lender(request, items, item_numer=10):
    if not items:
        return True, "These is no items"
